...
public class AdapterChannelYoutube extends RecyclerView.Adapter<AdapterChannelYoutube.ViewHolder> {
    Context mContext;
    int resourceId;
    ArrayList<ChannelYoutube> data = new ArrayList<ChannelYoutube>();

    public AdapterChannelYoutube(Activity context, int layoutResourceId, ArrayList<ChannelYoutube> data) {
